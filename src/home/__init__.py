...
class HomePage(PageSurface):
    ...
    def after_game_draw(self):
        ...
        Game.screen.blit(self.ground_surface_3[0], (self.bg_offset_ground3, self.ground_surface_3[1]))
    
    def draw(self):
        Game.screen.fill(self.bgs['sky'], ((0, 0), (Game.geometry.x, self.bg_pos_y)))
        ...
        Game.screen.blit(self.skin_surface[0], (self.bg_offset_skin, self.skin_surface[1]))
        ...
        Game.screen.blit(self.parallax_surface[0], (self.bg_offset_parallax, self.parallax_surface[1]))
        ...
        Game.screen.blit(self.ground_surface_1[0], (self.bg_offset_ground1, self.ground_surface_1[1]))

        Game.screen.fill(self.bgs['ground'], ((0, self.bg_pos_y), (Game.geometry.x, Game.geometry.y - self.bg_pos_y)))
        ...
        Game.screen.blit(self.ground_surface_2[0], (self.bg_offset_ground2, self.ground_surface_2[1]))
